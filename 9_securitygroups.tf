...
resource "aws_security_group" "web-elb-security-group" {
  name        = "week4-web-elb-public-security-group"
...
resource "aws_security_group" "web-app-security-group" {
  name        = "week4-web-app-private-security-group"
  ...
  tags = {
    Name = "week4-web-private-security-group"
  }
}
...
resource "aws_security_group" "bastion-security-group" {
  name        = "week4-bastion-public-security-group"
